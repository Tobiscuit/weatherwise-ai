...
function getLocationTime(lat: string, lon: string): { time: string; date: string } {
  try {
...
export async function getWittyWeatherParagraph(weatherData: WeatherData, lat?: string, lon?: string): Promise<string> {
